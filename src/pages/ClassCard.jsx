...
const ClassCard = ({item}) => {
    ...
    return (
        <div>
      <div className="card w-[20rem] hover:shadow-2xl   bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    item.description.length>50?      <p className="text-left font-sm bg-gradient-to-r text-transparent bg-clip-text from-cyan-500 to-blue-500">
          {item.description.slice(0,50)}... 
               <br />  <Link to={`/classes/${item.id}`} className='bg-gradient-to-r text-transparent bg-clip-text from-cyan-500 to-red-500 font-bold hover:text-yellow-700 '>
