...
const Banner = () => {
 ...
 <div className="hero min-h-screen  " style={{backgroundImage: 'url(https://i.ibb.co/mbKr6TV/background-1.jpg)'}}
 
 >
    <div className="hero-overlay bg-opacity-80 bg-slate-600"></div>
  <div className="hero-content relative text-left -left-[20rem] items-start text-neutral-content">
